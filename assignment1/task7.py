...
print("Here is the result of the two algorithms:")
test_model(MultinomialNB(alpha=2),train,train_class,test,test_class)
test_model(LogisticRegression(C=10),train,train_class,test,test_class)
