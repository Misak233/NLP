...
model.add(layers.Dense(30, input_dim=vocab_size, activation='relu'))
model.add(layers.Dense(27, input_dim=vocab_size, activation='relu'))
...
model.fit(train_matrix,train_label, epochs=30, verbose=True,validation_data=(train_matrix1, train_label1), batch_size=23)
model.summary()
