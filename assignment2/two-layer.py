...
model.add(layers.Dense(24, input_dim=vocab_size, activation='relu'))
...
model.fit(train_matrix,train_label, epochs=30, verbose=True,validation_data=(train_matrix1, train_label1), batch_size=32)
model.summary()
